unit OrdenesEntradasSeleccionGrid;
...
type
  TfrmOrdenesEntradasSeleccionGrid = class(T_frmGrid)
...
procedure TfrmOrdenesEntradasSeleccionGrid.tvMasterDblClick(Sender: TObject);
begin
  inherited;
  Close;
end;
