inherited dmOrdenesEntradas: TdmOrdenesEntradas
  ...
  inherited adodsMaster: TADODataSet
    ...
    CommandText = 
      ...
      'atus, IdOrdenEntradaTipo, IdPersona, IdMoneda, IdUsuario, Fecha,' +
      ' TipoCambio, SubTotal, IVA, Total, Observaciones '#13#10'from OrdenesE' +
      'ntradas'#13#10'Order by Fecha DESC'
  ...
  object adoqryDocumentoDetalles: TADOQuery
    ...
    SQL.Strings = (
        ...
        'WHEN OrdenesEntradasItems.PrecioVenta <> 0 THEN ((OrdenesEntrada' +
        'sItems.PrecioVenta - OrdenesEntradasItems.CostoAproximado) '
      
        '                         / OrdenesEntradasItems.PrecioVenta) * 1' +
        '00 ELSE 0 END AS Utilidad, Productos.Descripcion AS Producto,'
