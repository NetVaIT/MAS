inherited dmCotizaciones: TdmCotizaciones
  ...
  inherited adodsMaster: TADODataSet
    ...
    object adodsMasterIDMetPagoDirCli: TIntegerField
      FieldKind = fkLookup
      FieldName = 'IDMetPagoDirCli'
      LookupDataSet = ADODtStDireccionesCliente
      LookupKeyFields = 'IdPersonaDomicilio'
    ...
    object adodsMasterCtaCLienteDom: TStringField
      FieldKind = fkLookup
      FieldName = 'CtaCLienteDom'
      LookupDataSet = ADODtStDireccionesCliente
      LookupKeyFields = 'IdPersonaDomicilio'
      LookupResultField = 'NumCtaPagoCliente'
      KeyFields = 'IdDomicilioCliente'
      Size = 30
      Lookup = True
    end
  ...
  object adodsCotizacionesDetalle: TADODataSet
    ...
    CommandText = 
      ...
      'tario, Importe'#13#10' FROM DocumentosSalidasDetalles where IdDocument' +
      'oSalida=:IdDocumentoSalida'
    DataSource = DSMaster
    ...
    object adodsCotizacionesDetalleDisponible: TFloatField
      FieldKind = fkLookup
      FieldName = 'Disponible'
      LookupDataSet = adodsProductos
      LookupKeyFields = 'IdProducto'
      LookupResultField = 'ExistenciaReal'
      KeyFields = 'IdProducto'
      Lookup = True
    end
  ...
  object ppDBPplnItemsCotizacion: TppDBPipeline
  ...
  object ADODtStDireccionesEnvio: TADODataSet
    ...
    CommandText = 
      'select PD.IdPersonaDomicilio, PD.IdPersona, Pd.IdDomicilio, '#13#10'Pd' +
      '.IdDomicilioTipo, PD.Identificador, Pd.Predeterminado ,'#13#10'pd.IdEn' +
      'vioTipo'#13#10',D.Calle, D.NoExterior, D.NoInterior, D.Colonia, D.Codi' +
      'goPostal,'#13#10'M.DEscripcion Municipio, P.Descripcion Poblacion, E.D' +
      'escripcion Estado,'#13#10'Pa.descripcion Pais'#13#10#13#10'from PersonasDomicili' +
      'os PD'#13#10'inner join Domicilios D on PD.IDDomicilio=D.IDDomicilio'#13#10 +
      'Left Join Poblaciones P on P.idPoblacion=d.IdPoblacion'#13#10'left joi' +
      'n Municipios M on M.idmunicipio=D.IdMunicipio'#13#10'Left Join Estados' +
      ' E on E.idestado=D.idestado'#13#10'Left Join Paises Pa on Pa.idpais=D.' +
      'Idpais'#13#10'where PD.IDPersona=:IDPersona and PD.UsarParaEnvio=1'#13#10#13#10 +
      #13#10#13#10
    Parameters = <
      item
        Name = 'IDPersona'
