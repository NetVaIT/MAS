inherited DMFacturas: TDMFacturas
  ...
  inherited adodsMaster: TADODataSet
    ...
    object adodsMasterTipoComprobante: TStringField
      FieldKind = fkLookup
      FieldName = 'TipoComprobante'
      LookupDataSet = ADODtStTiposDocumentos
      LookupKeyFields = 'IdCFDITipoDocumento'
      LookupResultField = 'TipoComprobante'
      KeyFields = 'IdCFDITipoDocumento'
      Size = 10
      Lookup = True
    end
    object adodsMasterDirCompletaCte: TStringField
      FieldKind = fkLookup
      FieldName = 'DirCompletaCte'
    ...
    object adodsMasterTotalEnLetra: TStringField
  ...
  inherited ActionList: TActionList
    ...
    object ActPreFacturaNotaVenta: TAction
      Caption = 'Factura NotaVenta'
      OnExecute = ActPreFacturaNotaVentaExecute
    end
    object ActImpNotasVenta: TAction
    ...
    object ActMostrarGuia: TAction
      Caption = 'ActMostrarGuia'
      OnExecute = ActMostrarGuiaExecute
    end
    object ActDocACotiza: TAction
  ...
  object ADODSNotasVenta: TADODataSet
    ...
    CommandText = 
      ...
      'FDI '#13#10'where IdCFDITipoDocumento=4 and IDCFDIEstatus= 1'#13#10'and IdCF' +
      'DIFacturaGral is NULL and fecha >(getDATE()-1)and Fecha <GETDATE' +
      '()+1'#13#10'order by IDCFDIESTATUS, Fecha '
    Parameters = <>
    Left = 824
    Top = 448
  end
  object ADODtStConceptosNotasVenta: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    AfterPost = ADODtStCFDIConceptosAfterPost
    CommandText = 
  ...
  object DSNotasVenta: TDataSource
    DataSet = ADODSNotasVenta
    Left = 904
    Top = 448
  end
  object ppRprtNotaVenta: TppReport
    AutoStop = False
    ...
    Template.FileName = 'C:\Desarrollo\TractoPartes\MAS\Procesos\NotaVenta.rtm'
    ...
    Version = '15.0'
    mmColumnWidth = 0
    DataPipelineName = 'ppDBPplnItemsNotaVenta'
  ...
  object ppDBPplnItemsNotaVenta: TppDBPipeline
    DataSource = DSConceptosNotasVenta
    UserName = 'ItemsCotizacion'
    Left = 858
    Top = 98
  ...
  object DSConceptosNotasVenta: TDataSource
  ...
  object ADODtStVerificaGuia: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    CommandText = 
      ' Select IdDocumentoGuia from InformacionEntregas '#13#10'where IdinfoE' +
      'ntrega=(Select IdInfoEntrega from InformacionEntregasDetalles wh' +
      'ere IdOrdenSalida =:IdOrdenSalida) '
    Parameters = <
      item
        Name = 'IdOrdenSalida'
        Size = -1
  ...
  object ADODtStVerificaDocs: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    CommandText = 
      ' Select DSA.IdDocumento,D.NombreArchivo from DocumentosSalidasAr' +
      'chivos DSA  inner join Documentos D on DSA.IdDocumento=D.IdDocum' +
      'ento'#13#10' where  IdDocumentoSalida= (Select IdDocumentoSalida from ' +
      'OrdenesSalidas where IdOrdenSalida =:IdOrdenSalida) '
    Parameters = <
      item
        Name = 'IdOrdenSalida'
        DataType = ftInteger
    ...
    Left = 960
    Top = 568
    object ADODtStVerificaDocsIdDocumento: TIntegerField
      FieldName = 'IdDocumento'
    end
    object ADODtStVerificaDocsNombreArchivo: TStringField
      FieldName = 'NombreArchivo'
      Size = 200
    end
  end
