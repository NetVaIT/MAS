inherited dmProductos: TdmProductos
  ...
  object ADODtStPreciosMayoreo: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    CommandText = 
      'select IdProductoPrecioMayoreo, IdProducto, Escala,'#13#10' PrecioXEsc' +
      'ala from ProductosPreciosMayoreo'#13#10'Where IdProducto=:Idproducto'
    DataSource = dsMaster
    MasterFields = 'Idproducto'
    Parameters = <
      item
    ...
    Left = 680
    Top = 24
    object ADODtStPreciosMayoreoIdProductoPrecioMayoreo: TAutoIncField
      FieldName = 'IdProductoPrecioMayoreo'
      ReadOnly = True
    end
    object ADODtStPreciosMayoreoIdProducto: TIntegerField
      FieldName = 'IdProducto'
    end
    object ADODtStPreciosMayoreoEscala: TFloatField
      FieldName = 'Escala'
    end
    object ADODtStPreciosMayoreoPrecioXEscala: TFloatField
      FieldName = 'PrecioXEscala'
      currency = True
    end
    object ADODtStPreciosMayoreoProducto: TStringField
      FieldKind = fkLookup
      FieldName = 'Producto'
  ...
  object ppRprtPrecioMayoreo: TppReport
    AutoStop = False
    ...
    PrinterSetup.DevMode = {
      ...
      00000000}
    Template.FileName = 'C:\Desarrollo\TractoPartes\MAS\Procesos\ListaEscalaMayoreo.rtm'
    ...
    Version = '15.0'
    mmColumnWidth = 0
    DataPipelineName = 'ppDBPplnPrecioMayoreo'
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel15: TppLabel
        UserName = 'Label8'
        AutoSize = False
        Caption = 'Precios no Incluyen IVA'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Rounded MT Bold'
        Font.Size = 11
      ...
      object ppLabel17: TppLabel
        UserName = 'Label9'
        AutoSize = False
        Caption = 'Descripcion, usos y aplicaciones'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 9
      ...
      object ppSystemVariable4: TppSystemVariable
        ...
        DisplayFormat = 'dd '#39'de'#39' mmm '#39'del'#39' yyyy'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Rounded MT Bold'
        Font.Size = 11
    ...
    object ppFooterBand1: TppFooterBand
      ...
      object ppLabel20: TppLabel
        UserName = 'Label13'
        AutoSize = False
        Caption = 'Cambio sin previo aviso'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Rounded MT Bold'
        Font.Size = 11
  ...
  object ppDBPplnPrecioMayoreo: TppDBPipeline
    DataSource = DSPrecioXEscala
    UserName = 'DBPplnPrecioMayoreo'
    Left = 522
    Top = 371
  end
  object ADODtStPrecioXEscala: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    CommandText = 
      'select P.Descripcion,P.identificador1,  Escala, PrecioXEscala'#13#10' ' +
      ' from ProductosPreciosMayoreo PM'#13#10' inner join Productos P on P.I' +
      'dProducto = PM.IdProducto'#13#10
    Parameters = <>
    Left = 616
    Top = 384
    object ADODtStPrecioXEscalaidentificador1: TStringField
      FieldName = 'identificador1'
      Size = 50
    end
    object ADODtStPrecioXEscalaDescripcion: TStringField
      FieldName = 'Descripcion'
      Size = 255
    end
    object ADODtStPrecioXEscalaEscala: TFloatField
      FieldName = 'Escala'
    end
    object ADODtStPrecioXEscalaPrecioXEscala: TFloatField
      FieldName = 'PrecioXEscala'
    end
  end
  object DSPrecioXEscala: TDataSource
