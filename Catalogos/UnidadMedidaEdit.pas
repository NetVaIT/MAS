...
type
  TfrmUnidadMedidaEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
...
uses UnidadMedidaDM, UnidadMedidaForm;

procedure TfrmUnidadMedidaEdit.FormCreate(Sender: TObject);
begin
  inherited;
