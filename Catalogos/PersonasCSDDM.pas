...
uses PersonasCSDEdit, DocumentosDM;
...
begin
  inherited;
  gGridEditForm := TFrmPersonasCSDEdit.Create(Self);
  gGridEditForm.DataSet:= adodsMaster;
  TFrmPersonasCSDEdit(gGridEditForm).UpdateFileCER := actUpdateFileCER;
  TFrmPersonasCSDEdit(gGridEditForm).UpdateFileKEY := actUpdateFileKEY;
end;
