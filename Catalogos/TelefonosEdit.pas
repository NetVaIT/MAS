...
uses
  ...
  cxCheckBox, cxDBEdit, cxTextEdit, Vcl.StdCtrls, dxSkinscxPCPainter,
  cxPCdxBarPopupMenu, cxScrollBox, cxPC;

type
  TfrmTelefonosEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
    Label2: TLabel;
...
uses TelefonosDM, TelefonosForm;

procedure TfrmTelefonosEdit.FormCreate(Sender: TObject);
begin
  inherited;
