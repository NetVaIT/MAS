...
type
  TfrmZonasEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
...
uses AlmacenesDM, _AboutForm, ZonasForm;

procedure TfrmZonasEdit.FormCreate(Sender: TObject);
begin
  inherited;
  gFormGrid:= TfrmZonas.Create(Self);
end;
