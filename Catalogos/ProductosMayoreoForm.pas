...
type
  TFrmProductosPrecioMayoreoGrid = class(T_frmStandarGFormGrid)
    tvMasterEscala: TcxGridDBColumn;
    tvMasterPrecioXEscala: TcxGridDBColumn;
...
var
  FrmProductosPrecioMayoreoGrid: TFrmProductosPrecioMayoreoGrid;
