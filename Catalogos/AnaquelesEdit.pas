...
type
  TfrmAnaquelesEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
...
uses AlmacenesDM, AnaquelesForm;

procedure TfrmAnaquelesEdit.FormCreate(Sender: TObject);
begin
  inherited;
  gFormGrid:= TfrmAnaqueles.Create(Self);
end;
