...
type
  TfrmPoblacionesEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
    Label2: TLabel;
...
uses UbicacionesDM, PoblacionesForm;

procedure TfrmPoblacionesEdit.FormCreate(Sender: TObject);
begin
  inherited;
