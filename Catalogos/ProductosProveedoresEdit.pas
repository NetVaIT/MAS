...
uses
  ...
  cxTextEdit, cxMaskEdit, cxDropDownEdit, cxCalendar, Vcl.DBCtrls, Vcl.StdCtrls;

type
  TfrmProductosProveedoresEdit = class(T_frmStandarGFormEdit)
    Label1: TLabel;
...
uses ProductosDM, ProductosProveedoresForm;

procedure TfrmProductosProveedoresEdit.FormCreate(Sender: TObject);
begin
  inherited;
  gFormGrid:= TfrmProductosProveedores.Create(Self);
end;
